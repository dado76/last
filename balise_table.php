...
<?php include('bilangeo.php'); ?>
    		...
    		<a href="http://www.google.com" target="_parent"><button type="button" id="Ajouter_button" data-toggle="modal" data-target="#userModal" class="btn btn-success btn"><i class="fa fa-print"></i> Imprimer</button></a>
			<a href="http://www.google.com" target="_parent"><button type="button" href="export.php" class="btn btn-success btn"><i class="fa fa-file-excel"></i> Export</button></a>
  <?php  

  
	?>
<form method="post" name="search">
            <?php     $sql = 'SELECT codification FROM carte_sims';
                        $req = $connection->query($sql);
						?>	<select name="search"> <?php
                        while($data = $req->fetch()){  
				
				
            ?>        <option><?php echo $data['codification'];?>
...
{
	$query .= 'WHERE codification ="'.$_POST['search'];
