...
<nav class="w3-sidebar w3-collapse w3-white w3-animate-left" style="z-index:3;width:300px;" id="mySidebar"><br>
  ...
  <div class="w3-bar-block">
    ...
    <a href="#" class="w3-bar-item w3-button w3-padding w3-blue"><i class="fa fa-home fa-fw"></i>Accueil</a>
    ...
    <a href="#" class="w3-bar-item w3-button w3-padding"><i class="fa fa-truck fa-fw"></i>Véhicule de collecte</a>
    ...
    <a href="#" class="w3-bar-item w3-button w3-padding"><i class="fa fa-power-off fa-fw"></i>  Settings</a><br><br>
  </div>
</nav>
