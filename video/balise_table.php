...
<?php include('../bilanvideo.php'); ?>
			...
			<a href="videoExport.php" target="_parent"><button type="button" href="videoExport.php" class="btn btn-success btn"><i class="fa fa-file-excel"></i> Export</button></a>
  <?php
				...
				<table id="user_data" class="table table-bordered table-striped">
					<thead>
						<tr>
						    ...
						    <th width="10%">Numéro de série</th>
							<th width="10%">repere</th>
							<th width="10%">date_installation</th>
							<th width="10%">duree_garantie</th>
							<th width="10%">etat_garantie</th>
								<th width="10%">ip</th>
									<th width="10%">mac</th>
		...
		<form method="post" id="user_form" enctype="multipart/form-data">
			<div class="modal-content">
				...
				<div class="modal-body">
					...
					<br />
					<label>date_installation</label>
					<input type="text" name="date_installation" id="date_installation" class="form-control" />
					<br />
				<label>duree_garantie</label>
					<input type="text" name="rfid" id="rfid" class="form-control" />
					<br />
					<label>etat_garantie</label>
						<input type="text" name="rfid" id="rfid" class="form-control" />
						<br />
